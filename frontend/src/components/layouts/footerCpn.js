                    ...
                    <div className={`${styles.footerContent}`}>
                        ...
                        <div className={`${styles.contentCol} d-block justify-content-center`}>
                            ...
                            <div className={`${styles.childContent}`}>
                                ...
                                <Link href="/blogs/chinh-sach-bao-mat" style={{ textDecoration: 'none', color: 'black' }}>
                                    Chính sách bảo mật
                                </Link>
                            </div>
                            <div className={`${styles.childContent}`}>
                                ...
                                <Link href="/blogs/đieu-khoan-su-dung-website" style={{ textDecoration: 'none', color: 'black' }}>
                                    Điều khoản sử dụng
                                </Link>
                            </div>
                        </div>
